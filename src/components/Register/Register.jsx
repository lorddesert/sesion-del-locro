        ...
        <form className='registerForm'>
          <div style={{display: 'flex', placeItems: 'center'}}>
           <img src={this.state.img} alt='imagen del usuario'/>
            ...
            />
            <input type="file" style={{display: 'none'}} id='fileInput' onChange={this.getRegisterImg}/>
          </div>
