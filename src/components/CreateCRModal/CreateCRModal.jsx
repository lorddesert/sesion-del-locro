  ...
  if (props.inChatRoom) {
    return (
      <Modal closeModal={props.toggleModal}>
        ...
        <input type="text" id='chatRoomName' name='chatRoom' required onFocus={props.handleInputFocus} onBlur={props.handleInputFocus}/>
        <h2>Mensaje de estado</h2>
        <label htmlFor="chatRoom"></label>
        <input type="text" id='chatRoomState' name='chatRoom' required onFocus={props.handleInputFocus} onBlur={props.handleInputFocus}/>
